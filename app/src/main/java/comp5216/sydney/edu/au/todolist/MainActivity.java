...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Reference the "listView" varible with the id "lstView" in the layout
        listView = (ListView) this.findViewById(R.id.lstView);
    ...
    public void onButtonClick(View view) {
        ...
        String txtToAdd = addItemEditText.getText().toString();
        if(txtToAdd != null && txtToAdd != "") {
            itemsAdapter.add(txtToAdd);
